...
object GatewayErrors {
  final case object AgreementNotFoundForOrganizationError
      extends ComponentError("0001", "No agreement was found for your organization")
  ...
  final case class AttributeNotFoundError(attributeId: String)
      extends ComponentError("0004", s"No attribute identified as $attributeId was found for your organization")
}
